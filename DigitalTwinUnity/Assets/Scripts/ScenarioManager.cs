...
public class ScenarioManager : MonoBehaviour
{
    ...
    public void RunDrought()
    {
        ...
        TwinEventLogger.Log("SCENARIO A", "DROUGHT CRITICAL — Potato Field: moisture 5%, temp 42°C", "warn");
    }
    ...
    public void RunHeatwave()
    {
        ...
        TwinEventLogger.Log("SCENARIO B", "HEATWAVE — All zones 47°C, humidity 10%", "warn");
    }
    ...
    public void RunDisease()
    {
        ...
        TwinEventLogger.Log("SCENARIO C", "BLIGHT DETECTED — Tomato Field 85% infection, 5 outbreak zones", "warn");
    }
