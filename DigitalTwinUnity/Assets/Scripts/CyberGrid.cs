...
public class CyberGrid : MonoBehaviour
{
    ...
    {
        // Map zone name → CropType so we can update the SHARED zone material directly.
        // All soil tiles in a zone share one material instance; updating it is O(1)
        // and guaranteed to apply regardless of shader property naming.
        CropType crop;
        switch (zoneName)
        {
